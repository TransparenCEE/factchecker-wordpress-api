...
Step 2: Create a new database for an administrative panel on the same mysql server as Wordpress is. Import the sql dump to create the table structure (sql file is placed in the factual.ro_db_structure folder)

Step 3: edit the /administrative/common/config.php file to match the database credentials and server configuration
